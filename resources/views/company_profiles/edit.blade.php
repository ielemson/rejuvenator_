...
<div class="card card-primary">
    ...
    <form action="{{ route('company_profiles.update', $profile->id) }}" method="POST" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        ...
        <div class="form-group">
            ...
            <input type="text" name="position" class="form-control" value="{{ $profile->position }}" required>
        </div>
        ...
        <div class="form-group">
            ...
            @if($profile->image)
                <img src="{{ Storage::url($profile->image) }}" alt="{{ $profile->name }}" class="img-thumbnail mt-2" width="150">
            @endif
        </div>
